...
const handlerPath = '../../../src/client/pages/api/glitch-trade-routes.js'
const tokenCurrencyPath = '../../../src/client/pages/api/token-currency.js'

describe('glitch-trade-routes API handler', () => {
  beforeEach(() => {
    jest.resetModules()
  })
  ...
  async function loadModule() {
    ...
    jest.doMock('../../../src/client/pages/api/glitch-log-utils.js', () => ({
      appendGlitchLogEntry: jest.fn()
    }))
