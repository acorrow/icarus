...
import { formatRelativeTime } from 'lib/ghostnet-formatters'
...
export default function PirateRadioPanel () {
  ...
  return (
    <section className={ghostnetStyles.tableSection}>
      <div className={ghostnetStyles.tableSectionHeader}>
        <h2 className={ghostnetStyles.tableSectionTitle}>Pirate Radio</h2>
        <p className={styles.subtitle}>
          Ghost Net’s outlaw signal crawler stitches together volunteer library submissions and station commercials
      ...
      <div className={`${ghostnetStyles.sectionFrame} ${styles.panelShell}`}>
