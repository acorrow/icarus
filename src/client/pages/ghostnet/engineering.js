...
export default function GhostnetEngineeringOpportunitiesPage () {
  ...
  const tableStatus = !componentReady
    ? 'loading'
    : craftable.length === 0
      ? 'empty'
      : 'populated'
            ...
            <div className={styles.sectionGroup}>
              ...
              <div className={styles.tableSection}>
                <DataTableShell
                  ...
                  status={tableStatus}
                  loadingContent='Synchronising manifest…'
                  emptyContent='No blueprints are currently within reach. Top up on materials or unlock additional engineers to expand the list.'
                  aria-label='Engineering opportunities ready for fabrication'
                >
                  <table className={`${tableStyles.dataTable} ${tableStyles.dataTableDense}`}>
                    <thead>
                      <tr>
                        <th>Blueprint</th>
                        ...
                        return (
                          ...
                          >
                            <td className={tableStyles.tableCellTop}>
                              ...
                              <div className={tableStyles.tableSubtext}>{item.blueprint.originalName}</div>
                              {moduleList.length > 0 && (
                            ...
                            <td className={`hidden-medium ${tableStyles.tableCellTop}`}>
