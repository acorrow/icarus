    ...
    <>
      ...
      <div style={{ padding: '.5rem 1rem', opacity: connected ? 1 : 0, zoom: '1.2', fontWeight: 'bold' }}>
        ...
        <div style={{ position: 'absolute', bottom: '1rem', left: '1rem', right: '1rem' }}>
          <div style={{ marginBottom: '1rem', textAlign: 'center', fontSize: '1.1rem' }}>
            <p className='text-muted' style={{ marginBottom: '.25rem' }}>Connect from a browser</p>
            <p style={{ margin: 0 }}>
              <span
